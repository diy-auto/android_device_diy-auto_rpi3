...
$(call inherit-product, device/diy-auto/rpi3/diy-auto/diy-auto.mk)
...
PRODUCT_NAME := rpi3
PRODUCT_DEVICE := rpi3
PRODUCT_BRAND := DIY-AUTO
PRODUCT_MODEL := DIY-AUTO_v1_rpi3
PRODUCT_MANUFACTURER := brcm

# Set screen size and densities
PRODUCT_AAPT_CONFIG := normal tvdpi ldpi mdpi hdpi xhdpi xxhdpi
PRODUCT_AAPT_PREF_CONFIG :=normal tvdpi ldpi mdpi hdpi xhdpi xxhdpi
#PRODUCT_AAPT_PREF_CONFIG := hdpi /ruslan
...
DEVICE_PACKAGE_OVERLAYS := device/diy-auto/rpi3/overlay
